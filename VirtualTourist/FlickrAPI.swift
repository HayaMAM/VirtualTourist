...
class FlickrAPI {
    ...
    func getImagesFromFlickr(chosenPin: Pin, _ pageNumber: Int, _ completionHandler: @escaping (_ result: [Photo]?, _ error: NSError?) -> Void) {
        ...
        let methodParameters: [String:String] = [
            ...
            Constants.FlickrParameterKeys.BoundingBox: bboxString(longitude:chosenPin.longitude , latitude: chosenPin.latitude),
            Constants.FlickrParameterKeys.Latitude: "\(chosenPin.latitude)",
            Constants.FlickrParameterKeys.Longitude: "\(chosenPin.longitude)",
